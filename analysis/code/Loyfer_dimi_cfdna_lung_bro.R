...
dmc_gr <- readRDS("/dcl02/leased/cglab/rscharpf/mnoe/PROJECTS/cfepigenetics/data/DMR_cfdna_lung_bro.rds")
...
temp <- temp[,c(1,2,7,8)]
temp <- melt(temp, id = c("dir", "group"))
temp$id <- file
temp <- as_tibble(temp)

saveRDS(temp, paste0("/dcs04/scharpf/data/mnoe/DMR_Loyfer/cfdna_lung_bro_dimi/",basename(file)))
