...
ls <- list.files("/dcs04/scharpf/data/annapragada/Liver_Curated/granges", full.names = T)
...
dmc_gr <- readRDS("/dcl02/leased/cglab/rscharpf/mnoe/PROJECTS/cfepigenetics/data/DMR_cfdna_liver.rds")
...
final <- c(final, sub)
saveRDS(final, paste0("/dcs04/scharpf/data/mnoe/DMR_Loyfer/cfdna_liver_zach/",basename(file)))
