...
dmc_gr <- readRDS("/dcl02/leased/cglab/rscharpf/mnoe/PROJECTS/cfepigenetics/data/DMR_cfdna_lung_alv.rds")
...
saveRDS(temp, paste0("/dcs04/scharpf/data/mnoe/DMR_Loyfer/cfdna_lung_alv_dimi/",basename(file)))
